...
BRIGHT_DATA_USERNAME = "hl_9d5dfb32"
BRIGHT_DATA_PASSWORD = "2t59fj8x5d03"
...
MAX_CONCURRENT_BROWSER_LAUNCHES = 1  # CRITICAL: 1 to prevent 4 browsers open (semaphore only controls launch, not total open)
